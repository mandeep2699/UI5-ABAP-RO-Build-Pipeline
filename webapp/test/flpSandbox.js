		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Transpo App",
									"targetURL": "#comtransportstransport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtransportstransport-display": {
								"semanticObject": "comtransportstransport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.transports.transport",
									"url": sap.ui.require.toUrl("com/transports/transport")
								}
							}
						}
					}
